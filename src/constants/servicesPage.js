export const servicesPageData = {
  ...
  body: (
    <>
      At <span>DoubleDigit</span>, we believe in blending creativity with data and AI-driven insights to craft solutions that are both beautiful and effective. Our mission is simple — to deliver measurable impact through innovation.
    </>
  ),
    ...
    services: {
      digitalMarketing: {
        ...
        keyOfferings: [
          ...
          "Audience Analysis & Performance Tracking",
          "ROI-focused Campaign Management"
        ]
      },
      aiToolsSupport: {
        heading: "AI Tools Support",
        body: "We harness the power of AI to make your business smarter. Our chatbots provide seamless customer support 24/7, while our agentic AI systems automate workflows, improve decision-making, and enhance operational efficiency.",
        keyOfferings: [
